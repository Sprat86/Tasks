...
Мария с Иваном договорились пообедать в кафе. Также они договорились разделить счет пополам, но с одним условием: если среди заказанных блюд есть то,
 ...
 2. блюдо, на которое у Марии аллергия представлена аргументом функции 'k' и обозначает позицию блюда в чеке;
 3. сумма, которую Мария внесла на счет представлена аргументом функции 'b'.
 Например:
Счет: [2, 4, 8]. У Марии аллергия на блюдо под номером arr.[k]=2, стоимостью 8. Мария должна внести на счет (2 + 4)/2 = 3. Если же Иван обсчитался и взял
 с Марии 7 ( (2 + 4 + 6)/2 ), то он должен вернуть ей обратно 4.
 Если 'b' = 7, то функция должна вернуть 4 - разницу между тем, что внесла Мария и тем, что должна была внести.
 Если 'b' = 3, то функция должна вернуть фразу "Bon Appetit".
 *
 */
